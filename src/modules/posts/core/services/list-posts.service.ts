...
import { IPostRepository, PaginatedPostsResult } from '@modules/posts/core/ports/post.repository.port';
...
export class ListPostsService {
    ...
    async execute(params: { page: number; limit: number }): Promise<PaginatedPostsResult> {
